...
import grpc
from SSEData_zsa import FunctionType
from ScriptEval_zsa import ScriptEval
...
class ExtensionService(SSE.ConnectorServicer):
    ...
    @staticmethod
    def _run_scripts(request, context):
        """
        Call for the bat script to run all python scripts in the scripts folder
        ...
        run_all_scripts = subprocess.Popen(filepath)
